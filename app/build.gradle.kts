...
// Overwrite checkout-specific version-control metadata with empty content so
// equivalent source and toolchain inputs can produce byte-identical artifacts
// across detached and named-branch checkouts.
